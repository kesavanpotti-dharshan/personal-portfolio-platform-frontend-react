...
import { Experience, SkillCategory, Certification, Education, Project } from './types';
...
export const PERSONAL_INFO = {
  ...
  summary: "Professional Software Developer with over 13 years of extensive experience in all phases of the Software Development Life Cycle (SDLC). Expert in designing, developing, and deploying enterprise-grade web applications using Microsoft technologies, Cloud-native architectures (Azure/Kubernetes), and modern frontend frameworks like React.",
};

export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    category: ".NET Ecosystem",
    skills: [".NET 8", ".NET Core", "ASP.NET MVC", "Web API", "C#", "Entity Framework", "WCF", "WPF", "LINQ", "ADO.NET"]
  },
  {
    category: "Cloud & DevOps",
    skills: ["Azure", "Kubernetes (AKS)", "Docker", "Helm", "Azure Service Bus", "CI/CD", "GitHub Actions", "Azure DevOps", "Azure Monitor", "Microservices"]
  },
  {
    category: "Frontend",
    skills: ["React v19", "TypeScript", "JavaScript (ES6+)", "HTML5/CSS3", "Tailwind CSS", "Bootstrap", "Redux", "RxJS", "Blazor", "Kendo UI"]
  },
  {
    category: "Databases & Tools",
    skills: ["SQL Server", "Azure SQL", "PostgreSQL", "Oracle", "MongoDB", "GIT", "TFS", "SSIS", "Jira", "Swagger/OpenAPI"]
  }
];
...
export const PROJECTS: Project[] = [
  {
    ...
    description: "Architected a toolkit for migrating legacy on-premise .NET Framework applications to Azure App Services and Functions. Reduced manual migration assessment time by 40%.",
  ...
  },
  {
    ...
    description: "A standardized reference architecture for high-scale microservices using AKS, Azure Service Bus, and Key Vault with managed identities.",
  ...
  },
  {
    ...
    description: "High-performance React dashboard displaying real-time financial metrics for wealth management advisors, using WebSocket integration.",
  ...
  },
  {
    ...
    description: "Centralized GitHub Actions workflow templates for enterprise-wide usage, enforcing security scans and automated deployment patterns.",
...
export const EXPERIENCES: Experience[] = [
  {
    ...
    technologies: ["C#", ".Net 8", "Azure", "React", "AKS", "Docker", "Microservices"]
  },
  {
    id: "nm-us",
    ...
    technologies: ["ASP.NET Core", "React", "Azure DevOps", "PostgreSQL", "GitHub Actions"]
  },
  {
    id: "nm-in",
    company: "Northwestern Mutual",
